...
interface PairingRepository : JpaRepository<PairingTeacherWithStudent, Int>{
    @Query(value = "SELECT * FROM pairing_teacher_with_student u WHERE u.id_student =:id", nativeQuery = true)
    fun findUserByIdStudent(@Param("id") id:Int): Optional<PairingTeacherWithStudent>
